...
import com.gimble.seekpot.databinding.FragmentLostItemBinding
...
class LostItemFrag : Fragment() {

    private lateinit var fireref : DatabaseReference
    private lateinit var itemlist: ArrayList<FoundItemData>
    private lateinit var binding : FragmentLostItemBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentLostItemBinding.inflate(inflater,container,false)
        setUp()
        return binding.root
    }
